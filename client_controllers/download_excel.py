...
def save_as_excel(json_string: str):
    ...
    for counter, value in enumerate(data_list):
        ...
        data_row = [birth_date, measurement_date, gestation_weeks, gestation_days, estimated_date_delivery, corrected_decimal_age, measurement_value, measurement_type, sds, centile]
        data.append(data_row)
    headings = ['birth_date', 'measurement_date', 'gestation_weeks', 'gestation_days', 'estimated_date_delivery', 'corrected_decimal_age', 'measurement_value', 'measurement_type', 'sds', 'centile']
